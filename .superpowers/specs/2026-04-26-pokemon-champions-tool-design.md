...
│   │   ├── PredictionResult.tsx # 選出予想3パターン表示
│   │   ├── PatternCard.tsx      # パターン1枚分のカード
  ...
  "pokemon": [
    {
      ...
      // GameWithに記載があれば実値、なければ null（表示時は競技標準値で補完）
    }
  ]
}
```
...
種族値など使用率データに含まれない基本情報はここから取得する。
  ...
  "pokemon": [
    {
      ...
      "mega_evolution": {
        ...
        "resistances": ["ほのお", "くさ", "でんき", "むし", "はがね", "フェアリー"],
        "sprite_path": "sprites/006-mega-x.png"
      }
      // メガシンカしないポケモンは mega_evolution を null とする
    }
  ]
}
```
